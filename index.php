			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					<div id="logo" style="width: 180px; height: 100px; padding-top: 20px">
						...
						<a href="index.php" class="standard-logo" data-dark-logo="images/landing/logo1.png">
						<img src="images/landing/logo1.png" width="180" height="20" alt="Canvas Logo"></a>
						<a href="index.php" class="retina-logo" data-dark-logo="images/landing/logo1.png"><img src="images/landing/logo1.png" alt="Canvas Logo"></a>
					...
					<nav id="primary-menu" style="">
						...
						<ul>
							<li class="current" style="color:#C40000"><a href="index.php"><div>Home</div></a></li>

							<li><a href="about.html"><div>About Us</div></a></li>
							<li class="mega-menu"><a href="products.html"><div>Products & Services</div></a></li>
							<li class="mega-menu"><a href="client.html"><div>Our Clienteles</div></a></li>
							<li class="mega-menu"><a href="projects.html"><div>Key Projects</div></a></li>
							<li><a href="our_team.html"><div>Team</div></a>
								
							</li>
							<li class="mega-menu"><a href="contact.html"><div>Contact Us</div></a>
					...
					<div class="swiper-slide dark" style="  background:linear-gradient(0deg,rgba(0,0,0,0.50),rgba(0,0,0,0.50)),url('images/landing/img1.jpg');">
						<div class="container clearfix">
							<div class="slider-caption slider-caption-center">
								<h2 data-caption-animate="fadeInUp" style='font-size:40px'>Welcome to Kron Finance & Investments Limited</h2>
			...
			<div class="content-wrap">
				...
				<div class="promo promo-light promo-full bottommargin-lg header-stick notopborder">
					<div class="container clearfix" align="center">
						<h3>Call us today at <span style="color:red">(+233) 30 277 0666 / 20 817 8661</span> or Email us at <span>info@krongh.com</span></h3>
						...
						<h2>Is All About kron Finance & Investments Limited</h2>
...
.</p>
							<a href="products.html" class="button button-border button-light button-rounded button-reveal tright uppercase nomargin">
					...
					<div class="col-md-3 dark col-padding ohidden" style="background-color: #34495e;">
						<div>
							...
							<a href="client.html" class="button button-border button-light button-rounded uppercase nomargin">Read More</a>
					...
					<div class="col-md-3 dark col-padding ohidden" style="background-color: #34495e;">
						<div>
							...
							<a href="our_team.html" class="button button-border button-light button-rounded uppercase nomargin">Read More</a>
							<i class="icon-thumbs-up bgicon"></i>
						</div>
					</div>
						...
						<div class="col-md-3">
							...
							<div class="pricing-box">
								...
								<div class="pricing-action">
									<a href="our_companies.html" class="btn btn-danger btn-block btn-lg">Read more</a>
								</div>
							</div>
						...
						<div class="oc-item">
							<div class="iportfolio">
								...
								<div class="portfolio-desc">
									<h3><a href="portfolio-single.html">Finance & Manamgement Advisory</a></h3>
		...
		<footer id="footer" class="dark">
			...
			<div id="copyrights">
				...
				<div class="container clearfix">
					...
					<div class="col_half">
						Copyrights &copy; 2017 All Rights Reserved Kron Finance<br>
					...
					<div class="col_half col_last tright">
						...
						<i class="icon-envelope2"></i> info@krongh.com <span class="middot">&middot;</span> <i class="icon-headphones"></i> (+233) 30 277 0666 / 20 817 8661 <span class="middot">&middot;</span> 
					</div>
