...
<!-- Mirrored from codervent.com/rocker/white-version/authentication-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Dec 2018 12:54:06 GMT -->
<head>
    <meta charset="utf-8"/>
    ...
    <!-- animate CSS-->
    <link href="/backoffice/css/animate.css" rel="stylesheet" type="text/css"/>
    <!-- Icons CSS-->
    <link href="/backoffice/css/icons.css" rel="stylesheet" type="text/css"/>
    <!-- Custom Style-->
    <link href="/backoffice/css/app-style.css" rel="stylesheet"/>
                ...
                <form method="post">
                    <div class="form-group">
                        <div class="position-relative has-icon-right">
                            ...
                            <input required type="text" id="exampleInputUsername" class="form-control form-control-rounded" placeholder="Email" name="email">
                    ...
                    <div class="form-group">
                        <div class="position-relative has-icon-right">
                            ...
                            <input required type="password" id="exampleInputPassword" class="form-control form-control-rounded" placeholder="Password" name="password">
                            <div class="form-control-position">
                                <i class="icon-lock"></i>
                            </div>
                        </div>
